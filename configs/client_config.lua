...
clientconfig.Menu = {
    ...
    BLWordsOnScreen = {
        ...
        "Chocohax", "Inyection", "Inyected", "Dumper", "LUA Executor", "Executor", "Skid", "HamMafia", "HamHaxia", "Dopamine", "Miscellaneous", "Misc", "HoaX", "inSec", "Reaper", "Lux", "Event Blocker", "Cheats", "Cheat", "Destroyer", "Spectate", "Wallhack", "Exploit", "triggers", "crosshair", "Explosive",
